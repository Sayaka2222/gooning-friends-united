...
NDiplomacy = {
	...
	TRUCE_BREAK_COST_PP = 9999,						-- Base cost in PP of breaking a truce by joining a war or accepting a call to war ( you cannot declare war yourself until the truce if up ), this is then multiplied by the time left on the truce ( so once half the truce is up it only cost 50% of this )
...
NNavy = {
	...
	ALL_SHIPS_ACTIVATE_TIME = 16,                                    -- hours where all get to attack
